...
from guardrails_cli import autofix
from guardrails_cli import settings_store
...
def analyze_batch(
    ...
    require_ai_review: Optional[bool],
    ai_model: Optional[str],
    ai_review_max_chars: Optional[int],
    ...
    for path in files:
        ...
        try:
            ...
            if len(batch) >= args.chunk_size:
                ...
                for file_path, file_errors in findings.get("errors", {}).items():
